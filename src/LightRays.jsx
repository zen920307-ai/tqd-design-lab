...
const LightRays = ({
  ...
  useEffect(() => {
    ...
    const initializeWebGL = async () => {
      ...
      if (!effectActive || !containerRef.current) return;
...
void main() {
  ...
  gl_FragColor = color;
      ...
      const updatePlacement = () => {
        if (!effectActive || !containerRef.current || !renderer) return;
      ...
      const loop = (time) => {
        if (!effectActive || !rendererRef.current || !uniformsRef.current || !meshRef.current) return;
