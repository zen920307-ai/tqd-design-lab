...
// Find the first @media (max-width: 980px) block - this is the start of the problematic section
const first980 = c.indexOf('@media (max-width: 980px) {');

// Extract everything BEFORE the 980px block (the clean original content)
const before980 = c.substring(0, first980);

// Now append the mobile enhancements as PROPER flat top-level media queries
const mobileCSS = `
/* ============================================
...
@media (max-width: 980px) {
  ...
  .case-preview-card, .case-metrics {
    width: 100%;
  }
  .case-metrics {
    grid-template-columns: 1fr;
...
.mobile-view .site-header nav {
  display: none !important;
}

.mobile-view .GooeyNav {
  display: none;
}
...
const newContent = before980 + mobileCSS;
